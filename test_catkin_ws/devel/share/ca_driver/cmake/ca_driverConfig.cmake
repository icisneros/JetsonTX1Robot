...
if("TRUE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/nvidia/test_catkin_ws/src/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/nvidia/test_catkin_ws/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /home/nvidia/test_catkin_ws/install)
...
if(NOT "/home/nvidia/test_catkin_ws/src/create_autonomy/ca_driver/include;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/test_catkin_ws/src/create_autonomy/ca_driver/include;/opt/ros/kinetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/test_catkin_ws/src/create_autonomy/ca_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/test_catkin_ws/devel/lib;/home/nvidia/test_rviz3/devel/lib;/home/nvidia/test_catkin_ws/devel/lib;/opt/ros/kinetic/lib)
